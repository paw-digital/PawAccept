...
import (
	...
	ed25519 "github.com/paw-digital/ed25519-blake2b"
...
func blockCreate(previous, account, representative, balance, link, key, work string) (block createdBlock, err error) {
	...
	var li []byte
	if strings.HasPrefix(link, "paw_") || strings.HasPrefix(link, "xrb_") {
...
func accountToPublicKey(address string) (public []byte, err error) {
	...
	// First 4 are simply a hard-coded string paw_ for ease of use
